...
M.cfg = {
  ...
  is_file_binary_pre_read = function()
    binary_ext = { 'out', 'bin', 'dump', 'png', 'jpg', 'jpeg', 'gif', 'ico', 'icon', 'exe', 'dll', 'so', 'o', 'class', 'jmod', 'jar', 'zip', '7z', 'gz', 'tar' }
  ...
  is_file_binary_post_read = function()
    text_ext = { 'txt', 'log', 'patch', 'diff', 'java', 'c', 'cpp', 'h', 'hpp', 'go', 'py', 'rs', 'lua', 'yml', 'json', 'css', 'toml', 'Makefile', 'mk', 'sh', 'bash', 'zsh', 'csh', 'html', 'md', 'properties', 'cfg' }
    local ext = vim.fn.expand('%:e')
